...
class GPUAMDHardwareSampler : public ::testing::Test,
                              protected util::redirect_output<> { };

using namespace std::chrono_literals;

TEST_F(GPUAMDHardwareSampler, construct) {
...
TEST_F(GPUAMDHardwareSampler, construct_default_interval) {
    // construct a new AMD GPU hardware sampler
...
TEST_F(GPUAMDHardwareSampler, yaml_string) {
...
TEST_F(GPUAMDHardwareSampler, yaml_string_still_sampling) {
    // construct a new AMD GPU hardware sampler
    plssvm::detail::tracking::gpu_amd_hardware_sampler sampler{ 0 };
...
TEST_F(GPUAMDHardwareSampler, device_identification) {
    // construct a new AMD GPU hardware sampler
    const plssvm::detail::tracking::gpu_amd_hardware_sampler sampler{ 0 };
...
TEST_F(GPUAMDHardwareSampler, sampling_target) {
    // construct a new AMD GPU hardware sampler
    const plssvm::detail::tracking::gpu_amd_hardware_sampler sampler{ 0 };
...
TEST_F(GPUAMDHardwareSampler, output_operator) {
    // construct a new AMD GPU hardware sampler
    plssvm::detail::tracking::gpu_amd_hardware_sampler sampler{ 0 };
...
TEST_F(GPUAMDHardwareSampler, output_operator_still_sampling) {
    // construct a new AMD GPU hardware sampler
    plssvm::detail::tracking::gpu_amd_hardware_sampler sampler{ 0 };
