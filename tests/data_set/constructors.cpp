...
TYPED_TEST(DataSetMatrixConstructors, construct_from_empty_matrix) {
    ...
    // creating a data set from an empty vector is illegal
    EXPECT_THROW_WHAT((plssvm::data_set<label_type>{ plssvm::matrix<plssvm::real_type, layout>{ plssvm::shape{ 0, 0 }, plssvm::shape{ plssvm::PADDING_SIZE, plssvm::PADDING_SIZE } } }),
                      plssvm::data_set_exception,
                      "Data vector is empty!");
}
...
TYPED_TEST(DataSetMatrixConstructors, construct_from_matrix_without_label_wrong_padding_sizes) {
    ...
    {
        // create data points
        const auto data_points = util::generate_specific_matrix<plssvm::matrix<plssvm::real_type, layout>>(plssvm::shape{ 4, 4 }, plssvm::shape{ 0, plssvm::PADDING_SIZE });
        // create data set
    ...
    {
        // create data points
        const auto data_points = util::generate_specific_matrix<plssvm::matrix<plssvm::real_type, layout>>(plssvm::shape{ 4, 4 }, plssvm::shape{ plssvm::PADDING_SIZE, 0 });
        // create data set
...
TYPED_TEST(DataSetMatrixConstructors, construct_from_matrix_with_label_wrong_padding_sizes) {
    ...
    {
        const auto data_points = util::generate_specific_matrix<plssvm::matrix<plssvm::real_type, layout>>(plssvm::shape{ labels.size(), 4 }, plssvm::shape{ 0, plssvm::PADDING_SIZE });
        // create data set
    ...
    {
        const auto data_points = util::generate_specific_matrix<plssvm::matrix<plssvm::real_type, layout>>(plssvm::shape{ labels.size(), 4 }, plssvm::shape{ plssvm::PADDING_SIZE, 0 });
        // create data set
