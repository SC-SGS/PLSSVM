 ...
 *
 * @brief Tests for parsing a LIBSVM classification model file with an invalid header.
 */
...
#include "tests/utility.hpp"             // util::get_num_classes
...
template <typename T>
class LIBSVMClassificationModelHeaderParseInvalid : public ::testing::Test { };
