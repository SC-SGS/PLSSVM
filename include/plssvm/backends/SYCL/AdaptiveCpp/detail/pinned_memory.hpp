...
#ifndef PLSSVM_BACKENDS_SYCL_ADAPTIVECPP_DETAIL_PINNED_MEMORY_HPP_
#define PLSSVM_BACKENDS_SYCL_ADAPTIVECPP_DETAIL_PINNED_MEMORY_HPP_
#pragma once
...
class [[nodiscard]] pinned_memory final : public ::plssvm::detail::host_pinned_memory<T> {
    /// The template base type of the AdaptiveCpp pinned_memory class.
...
#endif  // PLSSVM_BACKENDS_SYCL_ADAPTIVECPP_DETAIL_PINNED_MEMORY_HPP_
