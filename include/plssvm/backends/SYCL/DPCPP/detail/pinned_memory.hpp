...
#ifndef PLSSVM_BACKENDS_SYCL_DPCPP_DETAIL_PINNED_MEMORY_HPP_
#define PLSSVM_BACKENDS_SYCL_DPCPP_DETAIL_PINNED_MEMORY_HPP_
#pragma once
...
class [[nodiscard]] pinned_memory final : public ::plssvm::detail::host_pinned_memory<T> {
    /// The template base type of the DPC++ pinned_memory class.
