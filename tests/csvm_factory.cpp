...
// TEST(CSVMFactory, invalid_constructor_parameter) { // TODO:@breyerml this testcase makes no sense here. we get an other exception if the cuda backend is not build!
