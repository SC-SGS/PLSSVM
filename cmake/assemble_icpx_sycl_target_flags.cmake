    ...
    if (DEFINED PLSSVM_INTEL_TARGET_ARCHS)
        ...
        elseif (PLSSVM_INTEL_TARGET_ARCH_NUM_HEX EQUAL PLSSVM_NUM_INTEL_TARGET_ARCHS)
            if (PLSSVM_NUM_INTEL_TARGET_ARCHS GREATER 1)
                message(FATAL_ERROR "When specifying the Intel architectures with HEX values, only a single architecture is supported but ${PLSSVM_NUM_INTEL_TARGET_ARCHS} where provided!")
            endif ()
            ...
            message(FATAL_ERROR "The provided Intel GPU target architectures (${PLSSVM_INTEL_TARGET_ARCHS}) are a mixture between device IDs (hex values) and architecture names but only either of them are supported!")
        endif ()
    endif ()
