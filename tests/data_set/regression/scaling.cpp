 ...
 *
 * @brief Tests for functions related to the regression data set scaling used for learning an SVM model.
 */
...
template <typename T>
class RegressionDataSetScaling : public ::testing::Test,
                                     private util::redirect_output<> {
  protected:
    using fixture_label_type = util::test_parameter_type_at_t<0, T>;
};

TYPED_TEST_SUITE(RegressionDataSetScaling, util::regression_label_type_gtest, naming::test_parameter_to_name);

TYPED_TEST(RegressionDataSetScaling, default_construct_factor) {
...
TYPED_TEST(RegressionDataSetScaling, construct_factor) {
    using label_type = typename TestFixture::fixture_label_type;
    using scaling_type = typename plssvm::regression_data_set<label_type>::scaling;
    using factor_type = typename scaling_type::factors;
...
TYPED_TEST(RegressionDataSetScaling, construct_interval) {
    using label_type = typename TestFixture::fixture_label_type;
    using scaling_type = typename plssvm::regression_data_set<label_type>::scaling;
...
TYPED_TEST(RegressionDataSetScaling, construct_invalid_interval) {
    using label_type = typename TestFixture::fixture_label_type;
    using scaling_type = typename plssvm::regression_data_set<label_type>::scaling;
...
TYPED_TEST(RegressionDataSetScaling, construct_from_file) {
    using label_type = typename TestFixture::fixture_label_type;
    using scaling_type = typename plssvm::regression_data_set<label_type>::scaling;
...
TYPED_TEST(RegressionDataSetScaling, save) {
    using label_type = typename TestFixture::fixture_label_type;
    using scaling_type = typename plssvm::regression_data_set<label_type>::scaling;
...
TYPED_TEST(RegressionDataSetScaling, save_empty_scaling_factors) {
    using label_type = typename TestFixture::fixture_label_type;
    using scaling_type = typename plssvm::regression_data_set<label_type>::scaling;
