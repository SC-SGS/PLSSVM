...
- `PLSSVM_ENABLE_PERFORMANCE_TRACKER` (default: `""`, i.e., `OFF`): enable gathering performance characteristics for the three executables using the specified YAML file 
