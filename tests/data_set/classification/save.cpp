 ...
 *
 * @brief Tests for functions related to saving a classification data set.
 */
...
template <typename T>
class ClassificationDataSetSave : public ::testing::Test,
...
TYPED_TEST(ClassificationDataSetSave, save_libsvm_with_label) {
    ...
    const plssvm::classification_data_set<label_type> data{ this->get_data_points(), this->get_label() };
