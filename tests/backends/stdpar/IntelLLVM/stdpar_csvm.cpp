...
class intel_llvm_stdparCSVM : public ::testing::Test,
                              private util::redirect_output<> { };

// check whether the constructor correctly fails when using an incompatible target platform
TEST_F(intel_llvm_stdparCSVM, construct_parameter) {
    // the automatic target platform must always be available
    EXPECT_NO_THROW(plssvm::stdpar::csvm{ plssvm::parameter{} });
}

TEST_F(intel_llvm_stdparCSVM, construct_target_and_parameter) {
...
TEST_F(intel_llvm_stdparCSVM, construct_target_and_named_args) {
