...
class csvc : virtual public csvm {
  public:
    ...
    [[nodiscard]] model<label_type> fit(const classification_data_set<label_type> &data, Args &&...named_args) const {
        std::cerr << "CLASSIFICATION FIT" << std::endl;
    ...
    [[nodiscard]] std::vector<label_type> predict(const model<label_type> &model, const classification_data_set<label_type> &data) const {
        std::cerr << "CLASSIFICATION PREDICT" << std::endl;
     ...
     */
    template <typename label_type>
    [[nodiscard]] real_type score(const model<label_type> &model, const classification_data_set<label_type> &data) const {
        std::cerr << "CLASSIFICATION SCORE" << std::endl;
