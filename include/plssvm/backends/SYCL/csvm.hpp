 ...
 */
class csvm : public ::plssvm::detail::gpu_csvm<detail::device_ptr, std::unique_ptr<detail::sycl::queue>> {
  protected:
    // protected for the test MOCK class
    /// The template base type of the SYCL C-SVM class.
    using base_type = ::plssvm::detail::gpu_csvm<detail::device_ptr, std::unique_ptr<detail::sycl::queue>>;
