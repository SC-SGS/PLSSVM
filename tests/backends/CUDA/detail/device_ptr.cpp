...
#include "../../../types_to_test.hpp"  // util::{combine_test_parameters_gtest_t, cartesian_type_t}
...
using device_ptr_test_types_gtest = util::combine_test_parameters_gtest_t<util::cartesian_type_product_t<device_ptr_test_types>>;
