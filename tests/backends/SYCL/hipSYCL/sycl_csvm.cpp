...
using hipsycl_solver_type_gtest = util::combine_test_parameters_gtest_t<hipsycl_csvm_test_type_list, util::solver_type_list>;
using hipsycl_kernel_function_type_gtest = util::combine_test_parameters_gtest_t<hipsycl_csvm_test_type_list, util::kernel_function_type_list>;
using hipsycl_solver_and_kernel_function_type_gtest = util::combine_test_parameters_gtest_t<hipsycl_csvm_test_type_list, util::solver_and_kernel_function_type_list>;
using hipsycl_label_type_kernel_function_and_classification_type_gtest = util::combine_test_parameters_gtest_t<hipsycl_csvm_test_label_type_list, util::kernel_function_and_classification_type_list>;
using hipsycl_label_type_solver_kernel_function_and_classification_type_gtest = util::combine_test_parameters_gtest_t<hipsycl_csvm_test_label_type_list, util::solver_and_kernel_function_and_classification_type_list>;

// instantiate type-parameterized tests
// generic CSVM tests
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericCSVM, hipsycl_csvm_test_type_gtest, naming::test_parameter_to_name);
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericCSVMSolver, hipsycl_solver_type_gtest, naming::test_parameter_to_name);
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericCSVMKernelFunction, hipsycl_kernel_function_type_gtest, naming::test_parameter_to_name);
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericCSVMSolverKernelFunction, hipsycl_solver_and_kernel_function_type_gtest, naming::test_parameter_to_name);
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericCSVMKernelFunctionClassification, hipsycl_label_type_kernel_function_and_classification_type_gtest, naming::test_parameter_to_name);
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericCSVMSolverKernelFunctionClassification, hipsycl_label_type_solver_kernel_function_and_classification_type_gtest, naming::test_parameter_to_name);

// generic CSVM DeathTests
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVMDeathTest, GenericCSVMSolverDeathTest, hipsycl_solver_type_gtest, naming::test_parameter_to_name);
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVMDeathTest, GenericCSVMKernelFunctionDeathTest, hipsycl_kernel_function_type_gtest, naming::test_parameter_to_name);
...
INSTANTIATE_TYPED_TEST_SUITE_P(hipSYCLCSVM, GenericGPUCSVMKernelFunction, hipsycl_kernel_function_type_gtest, naming::test_parameter_to_name);
