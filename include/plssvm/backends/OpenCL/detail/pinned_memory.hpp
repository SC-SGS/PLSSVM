...
#ifndef PLSSVM_BACKENDS_OPENCL_DETAIL_PINNED_MEMORY_HPP_
#define PLSSVM_BACKENDS_OPENCL_DETAIL_PINNED_MEMORY_HPP_
#pragma once
...
class [[nodiscard]] pinned_memory final : public ::plssvm::detail::host_pinned_memory<T> {
    /// The template base type of the OpenCL pinned_memory class.
