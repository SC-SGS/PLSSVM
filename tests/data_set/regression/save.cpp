 ...
 *
 * @brief Tests for functions related to saving a regression data set.
 */
...
template <typename T>
class RegressionDataSetSave : public ::testing::Test,
...
TYPED_TEST(RegressionDataSetSave, SaveLIBSVMWithLabel) {
    ...
    const plssvm::regression_data_set<label_type> data{ this->get_data_points(), this->get_label() };
