...
parser.add_argument("--name", help="the full name of the GPU (e.g. GeForce RTX 3080)")
...
if args.name is None:
    ...
    gpu_names.extend([pyamdgpuinfo.get_gpu(gpu_id).name for gpu_id in range(pyamdgpuinfo.detect_gpus())])
    if not gpu_names:
