...
// only include requested/available backends
    ...
    #include "plssvm/backends/OpenCL/csvm.hpp"  // plssvm::opencl::csvm, plssvm::csvm_backend_exists_v
        ...
        #include "plssvm/backends/SYCL/OpenSYCL/csvm.hpp"  // plssvm::opensycl::csvm, plssvm::csvm_backend_exists_v
    #endif
#endif
...
[[nodiscard]] inline std::unique_ptr<csvm> make_csvm_sycl_impl([[maybe_unused]] Args &&...args) {
    ...
    switch (impl_type) {
        ...
        case sycl::implementation_type::opensycl:
            return make_csvm_default_impl<opensycl::csvm>(std::forward<Args>(args)...);
    }
