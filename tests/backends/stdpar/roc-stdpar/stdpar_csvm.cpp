...
class roc_stdpar_stdparCSVM : public ::testing::Test,
                              private util::redirect_output<> { };

// check whether the constructor correctly fails when using an incompatible target platform
TEST_F(roc_stdpar_stdparCSVM, construct_parameter) {
...
TEST_F(roc_stdpar_stdparCSVM, construct_target_and_parameter) {
...
TEST_F(roc_stdpar_stdparCSVM, construct_target_and_named_args) {
