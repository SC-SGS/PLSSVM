...
__kernel void device_kernel_poly(__global const real_type *q, __global real_type *ret, __global const real_type *d, __global const real_type *data_d, const real_type QA_cost, const real_type cost, const int num_rows, const int num_cols, const int add, const int degree, const real_type gamma, const real_type coef0) {
    size_type i = get_group_id(0) * get_local_size(0) * INTERNAL_BLOCK_SIZE;
    size_type j = get_group_id(1) * get_local_size(1) * INTERNAL_BLOCK_SIZE;
