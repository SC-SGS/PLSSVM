...
class nvhpc_stdparCSVM : public ::testing::Test,
                         private util::redirect_output<> { };

// check whether the constructor correctly fails when using an incompatible target platform
TEST_F(nvhpc_stdparCSVM, construct_parameter) {
...
TEST_F(nvhpc_stdparCSVM, construct_target_and_parameter) {
...
TEST_F(nvhpc_stdparCSVM, construct_target_and_named_args) {
#if defined(PLSSVM_HAS_CPU_TARGET)
