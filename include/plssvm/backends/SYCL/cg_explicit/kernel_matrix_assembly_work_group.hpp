 ...
 *
 * @brief Functions for explicitly assembling the kernel matrix using the SYCL backend with work-group data parallel kernels.
 */

#ifndef PLSSVM_BACKENDS_SYCL_CG_EXPLICIT_KERNEL_MATRIX_ASSEMBLY_WORK_GROUP_HPP_
#define PLSSVM_BACKENDS_SYCL_CG_EXPLICIT_KERNEL_MATRIX_ASSEMBLY_WORK_GROUP_HPP_
#pragma once
