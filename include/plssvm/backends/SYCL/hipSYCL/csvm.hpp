...
class csvm : public ::plssvm::detail::gpu_csvm<detail::device_ptr, detail::queue> {
  ...
  private:
    ...
    /**
     * @copydoc plssvm::detail::gpu_csvm::run_blas_level_3_symm_kernel_explicit
     */
    void run_blas_level_3_symm_kernel_explicit(std::size_t m, std::size_t n, std::size_t k, real_type alpha, const device_ptr_type &A_d, const device_ptr_type &B_d, const real_type beta, device_ptr_type &C_d) const final;
