...
TEST_P(LIBSVMClassificationModelUtilityXvsY, OaoXvsYToIdx) {
    ...
    EXPECT_EQ(plssvm::detail::io::oao_x_vs_y_to_idx(y, x, num_classes), expected_idx);
}
...
TEST(LIBSVMClassificationModelUtilityXvsYDeathTest, XEqualToY) {
...
TEST(LIBSVMClassificationModelUtilityXvsYDeathTest, TooFewClasses) {
    EXPECT_DEATH(std::ignore = plssvm::detail::io::oao_x_vs_y_to_idx(0, 1, 1), "There must be at least two classes!");
}

TEST(LIBSVMClassificationModelUtilityXvsYDeathTest, XGreaterOrEqualThanNumClasses) {
...
TEST(LIBSVMClassificationModelUtilityXvsYDeathTest, YGreaterOrEqualThanNumClasses) {
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, IEqualToJ) {
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, TooFewIndexSets) {
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, IGreaterOrEqualThanNumIndices) {
    const std::vector<std::vector<std::size_t>> index_sets{ { 0, 1 }, { 2, 3 } };
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, JGreaterOrEqualThanNumIndices) {
    const std::vector<std::vector<std::size_t>> index_sets{ { 0, 1 }, { 2, 3 } };
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, IndexSetsNotSorted) {
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, IndicesInOneIndexSetNotUnique) {
...
TEST(LIBSVMClassificationModelUtilityAlphaIdxDeathTest, IndexSetsNotDisjoint) {
