...
//std::tuple<std::vector<device_ptr_t>, std::vector<device_ptr_t>, std::vector<std::size_t>>
...
//
//template <typename device_ptr_t, typename queue_t>
//template std::tuple<std::vector<device_ptr_t>, std::vector<device_ptr_t>, std::vector<std::size_t>> gpu_csvm<device_ptr_t, queue_t>::setup_data_on_device(const std::vector<std::vector<float>> &, std::size_t, std::size_t, std::size_t, std::size_t) const;
//template <typename device_ptr_t, typename queue_t>
//template std::tuple<std::vector<device_ptr_t>, std::vector<device_ptr_t>, std::vector<std::size_t>> gpu_csvm<device_ptr_t, queue_t>::setup_data_on_device(const std::vector<std::vector<double>> &, std::size_t, std::size_t, std::size_t, std::size_t) const;
