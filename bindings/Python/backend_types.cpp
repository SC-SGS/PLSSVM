...
void init_backend_types(py::module_ &m) {
    ...
    m.def("determine_default_backend", &plssvm::determine_default_backend, "determine the default backend given the list of available backends and target platforms",
