...
| constructors                                               | description                                                                                                                                                                                                              |
|------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `CSVM()`                                                   | Create a new CSVM with the default backend and target platform. The hyper-parameters are set to their default values.                                                                                                    |
| `CSVM([plssvm.Parameter kwargs])`                          | Create a new CSVM with the default backend and target platform. The hyper-parameter values are set ot the provided named parameter values.                                                                               |
| `CSVM(params)`                                             | Create a new CSVM with the default backend and target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter`.                                                                              |
| `CSVM(target)`                                             | Create a new CSVM with the default backend and the provided target platform. The hyper-parameters are set to their default values.                                                                                       |
| `CSVM(target, [plssvm.Parameter kwargs])`                  | Create a new CSVM with the default backend and the provided target platform. The hyper-parameter values are set ot the provided named parameter values.                                                                  |
| `CSVM(target, params)`                                     | Create a new CSVM with the default backend and the provided target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter`.                                                                 |
| `CSVM(target, params, [plssvm.Parameter kwargs])`          | Create a new CSVM with the default backend and the provided target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter` which are overriden with the provided explicit named parameters. |
| `CSVM(backend)`                                            | Create a new CSVM with the provided backend and the default target platform. The hyper-parameters are set to their default values.                                                                                       |
| `CSVM(backend, [plssvm.Parameter kwargs])`                 | Create a new CSVM with the provided backend and the default target platform. The hyper-parameter values are set ot the provided named parameter values.                                                                  |
| `CSVM(backend, params)`                                    | Create a new CSVM with the provided backend and the default target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter`.                                                                 |
| `CSVM(backend, params, [plssvm.Parameter kwargs])`         | Create a new CSVM with the provided backend and the default target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter` which are overriden with the provided explicit named parameters. |
| `CSVM(backend, target)`                                    | Create a new CSVM with the provided backend and target platform. The hyper-parameters are set to their default values.                                                                                                   |
| `CSVM(backend, target, [plssvm.Parameter kwargs])`         | Create a new CSVM with the provided backend and target platform. The hyper-parameter values are set ot the provided named parameter values.                                                                              |
| `CSVM(backend, target, params)`                            | Create a new CSVM with the provided backend and target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter`.                                                                             |
| `CSVM(backend, target, params, [plssvm.Parameter kwargs])` | Create a new CSVM with the provided backend and target platform. The hyper-parameters are explicitly set to the provided `plssvm.Parameter` which are overriden with the provided explicit named parameters.             |
