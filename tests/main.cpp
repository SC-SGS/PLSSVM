...
// generic C-SVC tests
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GenericCSVC);
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GenericCSVCKernelFunctionClassification);
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GenericCSVCSolverKernelFunctionClassification);
// generic C-SVR tests
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GenericCSVR);
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GenericCSVRKernelFunctionClassification);
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GenericCSVRSolverKernelFunctionClassification);
