 ...
 *
 * @brief Small wrapper around RAII enabled hipHostRegister.
 */

#ifndef PLSSVM_BACKENDS_HIP_DETAIL_PINNED_MEMORY_HIP_HPP_
#define PLSSVM_BACKENDS_HIP_DETAIL_PINNED_MEMORY_HIP_HPP_
#pragma once
...
class [[nodiscard]] pinned_memory final : public ::plssvm::detail::host_pinned_memory<T> {
    /// The template base type of the HIP pinned_memory class.
...
#endif  // PLSSVM_BACKENDS_HIP_DETAIL_PINNED_MEMORY_HIP_HPP_
