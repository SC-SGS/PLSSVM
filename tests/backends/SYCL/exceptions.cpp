...
struct sycl_exception_test_type {
    ...
    constexpr static std::string_view name = "sycl::backend_exception";
};
...
struct adaptivecpp_exception_test_type {
    ...
    constexpr static std::string_view name = "adaptivecpp::backend_exception";
};
...
struct dpcpp_exception_test_type {
    ...
    constexpr static std::string_view name = "dpcpp::backend_exception";
};
