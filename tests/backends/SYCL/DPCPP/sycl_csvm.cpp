...
#else
    EXPECT_THROW_WHAT((plssvm::dpcpp::csvm{ plssvm::target_platform::cpu, params }),
...
#else
    EXPECT_THROW_WHAT((plssvm::dpcpp::csvm{ plssvm::target_platform::gpu_nvidia, params }),
                      plssvm::dpcpp::backend_exception,
...
#else
    EXPECT_THROW_WHAT((plssvm::dpcpp::csvm{ plssvm::target_platform::gpu_amd, params }),
                      plssvm::dpcpp::backend_exception,
...
#else
    EXPECT_THROW_WHAT((plssvm::dpcpp::csvm{ plssvm::target_platform::gpu_intel, params }),
                      plssvm::dpcpp::backend_exception,
...
TEST_F(DPCPPCSVM, construct_target_and_named_args) {
    ...
    EXPECT_NO_THROW((plssvm::dpcpp::csvm{ plssvm::target_platform::cpu }));
#else
    ...
    EXPECT_NO_THROW((plssvm::dpcpp::csvm{ plssvm::target_platform::gpu_nvidia }));
#else
    ...
    EXPECT_NO_THROW((plssvm::dpcpp::csvm{ plssvm::target_platform::gpu_amd }));
#else
    ...
    EXPECT_NO_THROW((plssvm::dpcpp::csvm{ plssvm::target_platform::gpu_intel }));
#else
