 ...
 *
 * @brief Functions for explicitly performing a BLAS GEMM like matrix-matrix multiplication using the SYCL backend with basic data parallel kernels.
 */

#ifndef PLSSVM_BACKENDS_SYCL_CG_EXPLICIT_BLAS_BASIC_HPP_
#define PLSSVM_BACKENDS_SYCL_CG_EXPLICIT_BLAS_BASIC_HPP_
#pragma once
...
#endif  // PLSSVM_BACKENDS_SYCL_CG_EXPLICIT_BLAS_BASIC_HPP_
