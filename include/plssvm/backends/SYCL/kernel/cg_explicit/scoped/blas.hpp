  ...
  public:
    ...
    void operator()(T group) const {
        ::sycl::memory_environment(group,
                                   ...
                                   ::sycl::require_local_mem<real_type[THREAD_BLOCK_SIZE][THREAD_BLOCK_SIZE]>(),  // A_cache
                                   ::sycl::require_local_mem<real_type[THREAD_BLOCK_SIZE][THREAD_BLOCK_SIZE]>(),  // B_cache
