...
void init_gpu_intel_hardware_sampler(py::module_ &m) {
    ...
    py::class_<plssvm::detail::tracking::level_zero_general_samples>(tracking_module, "LevelZeroGeneralSamples")
        .def("get_name", &plssvm::detail::tracking::level_zero_general_samples::get_name)
        .def("get_standby_mode", &plssvm::detail::tracking::level_zero_general_samples::get_standby_mode)
        .def("get_num_threads_per_eu", &plssvm::detail::tracking::level_zero_general_samples::get_num_threads_per_eu)
        .def("get_eu_simd_width", &plssvm::detail::tracking::level_zero_general_samples::get_eu_simd_width)
    ...
    py::class_<plssvm::detail::tracking::level_zero_clock_samples>(tracking_module, "LevelZeroClockSamples")
        .def("get_clock_gpu_min", &plssvm::detail::tracking::level_zero_clock_samples::get_clock_gpu_min)
        .def("get_clock_gpu_max", &plssvm::detail::tracking::level_zero_clock_samples::get_clock_gpu_max)
        .def("get_available_clocks_gpu", &plssvm::detail::tracking::level_zero_clock_samples::get_available_clocks_gpu)
        .def("get_clock_mem_min", &plssvm::detail::tracking::level_zero_clock_samples::get_clock_mem_min)
        .def("get_clock_mem_max", &plssvm::detail::tracking::level_zero_clock_samples::get_clock_mem_max)
        .def("get_available_clocks_mem", &plssvm::detail::tracking::level_zero_clock_samples::get_available_clocks_mem)
        .def("get_tdp_frequency_limit_gpu", &plssvm::detail::tracking::level_zero_clock_samples::get_tdp_frequency_limit_gpu)
        .def("get_clock_gpu", &plssvm::detail::tracking::level_zero_clock_samples::get_clock_gpu)
        .def("get_throttle_reason_gpu", &plssvm::detail::tracking::level_zero_clock_samples::get_throttle_reason_gpu)
        .def("get_tdp_frequency_limit_mem", &plssvm::detail::tracking::level_zero_clock_samples::get_tdp_frequency_limit_mem)
        .def("get_clock_mem", &plssvm::detail::tracking::level_zero_clock_samples::get_clock_mem)
        .def("get_throttle_reason_mem", &plssvm::detail::tracking::level_zero_clock_samples::get_throttle_reason_mem)
    ...
    py::class_<plssvm::detail::tracking::level_zero_power_samples>(tracking_module, "LevelZeroPowerSamples")
        .def("get_energy_threshold_enabled", &plssvm::detail::tracking::level_zero_power_samples::get_energy_threshold_enabled)
        .def("get_energy_threshold", &plssvm::detail::tracking::level_zero_power_samples::get_energy_threshold)
        .def("get_power_total_energy_consumption", &plssvm::detail::tracking::level_zero_power_samples::get_power_total_energy_consumption)
    ...
    py::class_<plssvm::detail::tracking::level_zero_memory_samples>(tracking_module, "LevelZeroMemorySamples")
        .def("get_memory_total", &plssvm::detail::tracking::level_zero_memory_samples::get_memory_total)
        .def("get_allocatable_memory_total", &plssvm::detail::tracking::level_zero_memory_samples::get_allocatable_memory_total)
        .def("get_pcie_link_max_speed", &plssvm::detail::tracking::level_zero_memory_samples::get_pcie_link_max_speed)
        .def("get_pcie_max_width", &plssvm::detail::tracking::level_zero_memory_samples::get_pcie_max_width)
        .def("get_max_pcie_link_generation", &plssvm::detail::tracking::level_zero_memory_samples::get_max_pcie_link_generation)
        .def("get_bus_width", &plssvm::detail::tracking::level_zero_memory_samples::get_bus_width)
        .def("get_num_channels", &plssvm::detail::tracking::level_zero_memory_samples::get_num_channels)
        .def("get_location", &plssvm::detail::tracking::level_zero_memory_samples::get_location)
        .def("get_memory_free", &plssvm::detail::tracking::level_zero_memory_samples::get_memory_free)
        .def("get_pcie_link_speed", &plssvm::detail::tracking::level_zero_memory_samples::get_pcie_link_speed)
        .def("get_pcie_link_width", &plssvm::detail::tracking::level_zero_memory_samples::get_pcie_link_width)
        .def("get_pcie_link_generation", &plssvm::detail::tracking::level_zero_memory_samples::get_pcie_link_generation)
    ...
    py::class_<plssvm::detail::tracking::level_zero_temperature_samples>(tracking_module, "LevelZeroTemperatureSamples")
        .def("get_temperature_max", &plssvm::detail::tracking::level_zero_temperature_samples::get_temperature_max)
        .def("get_temperature_psu", &plssvm::detail::tracking::level_zero_temperature_samples::get_temperature_psu)
        .def("get_temperature", &plssvm::detail::tracking::level_zero_temperature_samples::get_temperature)
