#pragma once
#include "../include/CSVM.hpp"
#include "typedef.hpp"
#include "gmock/gmock.h"

class MockCSVM : public CSVM {
  public:
    MockCSVM(real_t cost_, real_t epsilon_, unsigned kernel_, real_t degree_, real_t gamma_, real_t coef0_, bool info_) : CSVM(cost_, epsilon_, kernel_, degree_, gamma_, coef0_, info_) {}
