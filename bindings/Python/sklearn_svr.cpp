...
struct svr {
    // the types
    using data_set_type = plssvm::regression_data_set<double>;
    using model_type = plssvm::regression_model<double>;
...
void init_sklearn_svr(py::module_ &m) {
    ...
    //*************************************************************************************************************************************//
    py_svr
        .def_property_readonly("coef_", [](const svr &) { throw py::attribute_error{ "'SVR' object has no attribute 'coef_' (not implemented)" }; }, "Weights assigned to the features when kernel=\"linear\". ndarray of shape (n_features, n_classes)")
        ...
        .def_property_readonly("intercept_", [](const svr &) { throw py::attribute_error{ "'SVR' object has no attribute 'intercept_' (not implemented)" }; }, "Constants in decision function. ndarray of shape (1,)")
        .def_property_readonly("n_features_in_", [](const svr &self) -> int {
            ...
            return static_cast<int>(self.data_->num_features()); }, "Number of features seen during fit. int")
        .def_property_readonly("feature_names_in_", [](const svr &) { throw py::attribute_error{ "'SVR' object has no attribute 'feature_names_in_' (not implemented)" }; }, "Names of features seen during fit. ndarray of shape (n_features_in_,)")
        .def_property_readonly("n_iter_", [](const svr &self) -> int {
            if (self.model_ == nullptr) {
                throw py::attribute_error{ "'SVR' object has no attribute 'support_'" };
            }

            return self.model_->num_iters().value().front(); }, "Number of iterations run by the optimization routine to fit the model. int")
        ...
        .def_property_readonly("support_vectors_", [](const svr &self) -> py::array {
            ...
            return plssvm::bindings::python::util::matrix_to_pyarray(plssvm::aos_matrix<plssvm::real_type>{ std::move(self.model_->support_vectors().to_2D_vector()) }); }, "Support vectors. ndarray of shape (n_SV, n_features)")
        .def_property_readonly("n_support_", [](const svr &self) -> py::array {
            if (self.model_ == nullptr) {
                throw py::attribute_error{ "'SVR' object has no attribute 'n_support_'" };
            }

            return plssvm::bindings::python::util::vector_to_pyarray(std::vector<std::int32_t>{ static_cast<std::int32_t>(self.model_->num_support_vectors()) }); }, "Number of support vectors for each class. ndarray of shape (1,), dtype=int32")
        .def_property_readonly("shape_fit_", [](const svr &self) {
            if (self.model_ == nullptr) {
                throw py::attribute_error{ "'SVR' object has no attribute 'shape_fit_'" };
            }

            return std::make_tuple(static_cast<int>(self.data_->num_data_points()), static_cast<int>(self.data_->num_features())); }, "Array dimensions of training vector X. tuple of int of shape (n_dimensions_of_X,)");

    //*************************************************************************************************************************************//
    //                                                               METHODS                                                               //
    //*************************************************************************************************************************************//
    py_svr
        .def("fit", [](svr &self, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> data, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> labels, const std::optional<std::vector<plssvm::real_type>> &sample_weight) -> svr & {
        ...
        .def("fit", [](svr &self, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> data, py::list labels, const std::optional<std::vector<plssvm::real_type>> &sample_weight) -> svr & {
            if (sample_weight.has_value()) {
                throw py::attribute_error{ "The 'sample_weight' parameter for a call to 'fit' is not implemented yet!" };
            }

            // fit the model using potentially provided keyword arguments
            self.data_ = std::make_unique<typename svr::data_set_type>(plssvm::bindings::python::util::pyarray_to_matrix(data), plssvm::bindings::python::util::pylist_to_vector<double>(labels));
            fit(self);
            return self; }, "Fit the SVM model according to the given training data.", py::arg("X"), py::arg("y"), py::pos_only(), py::arg("sample_weight") = std::nullopt, py::return_value_policy::reference)
        .def("get_params", [](const svr &self, const bool) -> py::dict {
        ...
        .def("predict", [](svr &self, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> data) -> py::array {
            if (self.model_ == nullptr) {
            ...
            return plssvm::bindings::python::util::vector_to_pyarray(self.svm_->predict(*self.model_, data_to_predict)); }, "Perform classification on samples in X.")
        .def("score", [](svr &self, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> data, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> labels, const std::optional<std::vector<plssvm::real_type>> &sample_weight) -> plssvm::real_type {
            if (sample_weight.has_value()) {
                throw py::attribute_error{ "The 'sample_weight' parameter for a call to 'fit' is not implemented yet!" };
            }
            if (self.model_ == nullptr) {
            ...
            return self.svm_->score(*self.model_, data_to_score); }, "Return the mean accuracy on the given test data and labels.", py::arg("X"), py::arg("y"), py::pos_only(), py::arg("sample_weight") = std::nullopt)
        .def("score", [](svr &self, py::array_t<plssvm::real_type, py::array::c_style | py::array::forcecast> data, py::list labels, const std::optional<std::vector<plssvm::real_type>> &sample_weight) -> plssvm::real_type {
            if (sample_weight.has_value()) {
                throw py::attribute_error{ "The 'sample_weight' parameter for a call to 'fit' is not implemented yet!" };
            }
            if (self.model_ == nullptr) {
            ...
            const typename svr::data_set_type data_to_score{ plssvm::bindings::python::util::pyarray_to_matrix(data), plssvm::bindings::python::util::pylist_to_vector<double>(labels) };
            return self.svm_->score(*self.model_, data_to_score); }, "Return the mean accuracy on the given test data and labels.", py::arg("X"), py::arg("y"), py::pos_only(), py::arg("sample_weight") = std::nullopt)
